			...
			<form action="BandRegistrationServlet" method="post">
				<%
					...
					if (req != null) {
						...
						if (cor == 34) {
							out.println("<p>SUCH BAND ALREADY EXISTS</p>");
						}
					}
				%>
				<p>
					<input type="text" name="BandName" placeholder="Band Name" required>
				</p>
				<p>
					<input type="text" name="Mail" placeholder="Mail" required>
				</p>
				<p>
					<textarea name="About" placeholder="About" rows="4" cols="26"></textarea>
				</p>
				<p class="submit">
